...
public class Joysticks {
    ...
    private final double axisDeadzone;

    public Joysticks(int controllerPin, double joystickDeadzone) {
        ...
        this.axisDeadzone = joystickDeadzone;
    }
    ...
    private double applyDeadband(double value) {
        return applyDeadband(value, axisDeadzone);
    }
